module Main exposing (Model, Msg(..), Section, applyRegex, by, getAt, init, initConcatenated, initSection, main, matchingSections, onChange, replace, update, view)
...
view model =
    div []
        ...
        , div []
            ...
            , textarea [ placeholder "before", cols 100, rows 10, onInput OnDomain ] [ text model.domain ]
            , hr [] []
            ]
        , div []
...
matchingSections model =
    List.indexedMap
        (\n ->
            \sec ->
                div []
                    [ button [ onClick (OnAddPrev n) ] [ text "add before" ]
